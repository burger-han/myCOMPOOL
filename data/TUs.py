    ...
    def get_all_split_idx(self, dataset):
        ...
        if not (os.path.exists(root_idx_dir + dataset.name + '_train.index')):
            ...
            for indexes in cross_val_fold.split(dataset.graph_lists, dataset.graph_labels):
                ...
                f_train_w = csv.writer(open(root_idx_dir + dataset.name + '_train.index', 'a', newline=""))
                f_val_w = csv.writer(open(root_idx_dir + dataset.name + '_val.index', 'a', newline=""))
                f_test_w = csv.writer(open(root_idx_dir + dataset.name + '_test.index', 'a', newline=""))
